...
/"The Alchymist, in Search of the Philosopher's Stone" (1771) by Joseph Wright of Derby — [[https://en.wikipedia.org/wiki/The_Alchymist][Wikipedia]]/
...
Tuned for macOS with [[https://pqrs.org/osx/karabiner/][Karabiner-Elements]]: Caps Lock remapped to Control, Cmd and Option swapped so physical Cmd becomes Meta, pixel-smooth scrolling, and =exec-path-from-shell= so Emacs inherits your =$PATH=.
